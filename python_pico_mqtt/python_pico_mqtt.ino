...
void connect() {
  ...
  Serial.print("\nconnecting...");
  while (!client.connect("naufa-pico-w-heartbeat", "RuX2xA0tsjaDXWkiFhlCABZWDacRMytA", "RuX2xA0tsjaDXWkiFhlCABZWDacRMytA")) {
    Serial.print(".");
    delay(1000);
  }
...
void updateToFavoriot(int average){
  ...
  String json = "{\"device_developer_id\":\"sleep_monitor@naufal3003\",\"data\":{\"heartbeat\":\""+String(average)+"\"}}";
  
  client.publish("RuX2xA0tsjaDXWkiFhlCABZWDacRMytA/v2/streams", json);
