...
(library Library_1
	...
	(patternDef "14-LEAD-OESIP" (originalName "14-LEAD-OESIP")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.284, -0.006) (textStyleRef "Normal") (isVisible True))
		)
	...
	(compDef "MAX30102EFD+" (originalName "MAX30102EFD+") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "R_DRV") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "IR_DRV") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "14" (pinName "N.C._4") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<STEP Filename>" "MAX30102EFD+.stp")
